...
<head>
    <title>Command Injection Labs</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="jumbotron text-center">
        ...
        <p>Welcome to Command Injection Labs, there is some labs you can try!</p>
    </div>
            ...
            <div class="col-sm-4">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">Simple command injection</p>
            ...
            <div class="col-sm-4">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">Blacklisted special character</p>
            ...
            <div class="col-sm-4">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">Blind command injection</p>
