<?php
    ...
    $id = $_GET['id'];
    $created_by = $_SESSION["username_user"];
	...
	$sql2 = "SELECT username FROM user WHERE username = '".$_SESSION["username_user"]."';";
                    ...
                    <form action="cek-edit-data.php" method="post" class="user">
                        ...
                        <!-- <div class="form-group">
                            <input type="text" class="form-control form-control-user"
                                id="nama_barang" name="nama_barang" placeholder="Enter Username..." value="<?php echo htmlspecialchars($nama_barang, ENT_QUOTES); ?>">
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-control form-control-user"
                                id="kuantitas" name="kuantitas" placeholder="Password" value="<?php echo htmlspecialchars($kuantitas, ENT_QUOTES); ?>">
                        </div> -->
