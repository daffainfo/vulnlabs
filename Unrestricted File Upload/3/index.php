...
<body>
    <div class="container m-5">
        ...
        <?php
        if (move_uploaded_file($_FILES["myfile"]["tmp_name"], $target_file) && mime_content_type($tmpName) == "image/gif" || mime_content_type($tmpName) == "image/png" || mime_content_type($tmpName) == "image/jpeg") {
