...
<head>
    <title>Cross Site Scripting | Level 18</title>
    <meta charset="utf-8">
...
<body>
    <div class="container m-5">
        ...
        <p id="clue" style="display:none">SVG file</p>
        ...
        <?php
        if (move_uploaded_file($_FILES["myfile"]["tmp_name"], $target_file) && $FileType === "jpg" || $FileType === "png" || $FileType == "jpeg") {
